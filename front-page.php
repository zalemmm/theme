      ...
      <div class="storycontent">
        ...
        <hr style="margin-bottom: 10px;" /><small>
          ...
          <small>
            ...
            RAPIDITÉ D'EXECUTION : possibilité de réalisations et livraisons de vos commandes en 24/48H ou 72H au choix
          </small>

            <div class="mc_texte" itemscope itemtype="http://schema.org/Product">
              Depuis maintenant 8 ans, <strong itemprop="brand">France Banderole</strong> vous offre le meilleur rapport qualité prix réactivité dans l'impression de bâche imprimée pour vous permmettre d'acheter des banderoles pour tous les usages. <button class="toggle-button">Lire la suite...</button>
