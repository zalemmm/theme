    ...
    <div class="row clearfix" ng-cloak>
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 editor_section">
            <div id="content" class="tabing">
                <ul id="tabs" class="row nav nav-tabs" data-tabs="tabs">
                    <li class="col-xs-3 active"><a ng-click="deactivateAll()" href="#Products" class="products" data-toggle="tab">
                      <i class="fa fa-info-circle"></i>Info</a>
                    </li>
                    <li  class="col-xs-3">
                      <a ng-click="deactivateAll()" href="#Graphics" class="graphics" data-toggle="tab"><i class="fa fa-picture-o" aria-hidden="true"></i>Image</a>
                    </li>
                    <li  class="col-xs-3">
                      <a ng-click="deactivateAll()" href="#Text" class="text" data-toggle="tab"><i class="fa fa-font" aria-hidden="true"></i>Texte</a>
                    </li>
                    <li  class="col-xs-3">
                      <a ng-click="layers()" href="#Layers"  class="calques" data-toggle="tab" data-toggle="tab"><i class="fa fa-object-ungroup"></i>Calques</a>
                    </li>
                </ul>
                <div id="my-tab-content" class="tab-content action_tabs">
                    <div class="tab-pane active clearfix" id="Products">
                      <h5 class="commande">commande n° <span id="number"><?php echo $nbcom;?></span></h5>
                      ...
                      <div class="encart">
                        ...
                        <div class="aide">
                          ...
                          <div class="intro">
                            ...
                            <!--<p class="astuce"><i class="fa fa-warning" style="color:#ea2a6a"></i> L'envoi peut prendre quelques minutes, attendez le message de confirmation avant de quitter l'application !</p>-->

                            <p class="dashed"><?php echo $dashdesc; ?></p>

                            <p class="astuce"><strong><i class="fa fa-info-circle"></i> Astuce:</strong> Pour sélectionner et décaler plusieurs éléments ensemble, cliquez sur chaque objet en maintenant la touche SHIFT enfoncée</p>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                  ...
                                                  <h4 class="alert alert-info"><i class="fa fa-question-circle"></i> Astuces / FAQ</h4>
                                                    <p  class="alert alert-info">
                                                        <strong>L'application est lente ou bloque le navigateur :</strong> Les images que vous importez doivent être de bonne résolution pour une impression de qualité, mais trop nombreuses ou trop lourdes elles peuvent ralentir beaucoup cette application:  il est donc conseillé de privilégier au maximum les ressources intégrées (textes, formes, icones etc) et les images au format 'svg' (ce type d'image est redimentionnable sans souci de charge serveur et de résolution). Si votre composition requier d'importer beaucoup d'images HD en jpeg ou png, il est vivement conseillé de passer par une solution logicielle type Photoshop.
                                                    </p>

                                                    <p class="alert alert-info">
                                                        <strong>Gabarit vierge après avoir cliqué sur rétablir ? </strong> Si vous avez une sauvegarde enregistrée mais que le bouton rétablir réinitialise votre gabarit, actualisez simplement la page pour retrouver votre sauvegarde.
                                                    </p>
                                                    ...
                                                    <p class="alert alert-info">
                                                        <strong>Lorsque vous envoyez votre maquette, attendez le message confirmation </strong> avant de fermer l'onglet ou le navigateur. Votre maquette sera ensuite contrôlée par un infographiste qui vous la retournera sous forme de BAT à valider.
                                                    </p>
                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="clip_arts">
                                ...
                                <div class="graphic_icons" ng-show="!graphic_icons">
                                  <div class="filter_by_cat">
                                    <div class="row graphCont">
                                        <button href="#" id="Formes" ng-model="graphicsCategory" ng-click="loadByGraphicsCat('Formes');" class="graphCats col-sm-3 col-xs-6 active"><i class="fa fa-star"></i> Formes</button>
                                        <button href="#" id="Silhouettes" ng-model="graphicsCategory" ng-click="loadByGraphicsCat('Silhouettes');" class="graphCats col-sm-3 col-xs-6"><i class="icon-56"></i> Silhouettes</a></button>
                                        <button href="#" id="Icones" ng-model="graphicsCategory" ng-click="loadByGraphicsCat('Icones');" class="graphCats col-sm-3 col-xs-6"><i class="fa fa-rocket"></i> Icones</button>
                                        <button href="#" id="Drapeaux" ng-model="graphicsCategory" ng-click="loadByGraphicsCat('Drapeaux');" class="graphCats col-sm-3 col-xs-6"><i class="fa fa-flag"></i> Drapeaux</button>
                                    </div>
                                  </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="upload_own">
                                <div class="thumb_listing">
                                    <div class="well">
                                        ...
                                        <h5 class="psm">Formats acceptés: jpg / jpeg / png / gif / svg</h5>
                                        ...
                                        <?php
                                          ...
                                          $repertoire = '../../../../uploaded/'.$nbcom.'/ressources/';
                                            ...
                                            $fichiers= '<div class="emptyImg">Cliquez sur le bouton ci-dessus pour importer des images depuis votre ordinateur, vous les retrouverez ici pour  toutes les maquettes d\'une même commande.</div>';
                                          }
                                        ?>
...
<!--                            <div role="tabpanel" class="tab-pane fade" id="word_cloud">
            ...
            <div ng-class="fabric.selectedObject ? 'activeControlsElem' : ''" ng-if='fabric.selectedObject.type' ng-switch='fabric.selectedObject.type'>
                ...
                <div class="well">
                    ...
                    <div class="row form-group transparency" title="Spacing" ng-show="fabric.selectedObject.type == 'curvedText'" style="margin-bottom: 15px;">
                        <md-input-container flex>
                  ...
                  <div class="w3-container w3-padding-large" ng-show="fabric.selectedObject.type != 'image' && fabric.selectedObject.type != 'path'">
                    <div class="w3-row1">
                      ...
                      <button id="result01" class="w3-col m2" value="{{fabric.selectedObject.fill}}" ng-model="fabric.selectedObject.fill" ng-change="fillColor(fabric.selectedObject.fill);" ng-click="adjust = !adjust" style="background-color: {{fabric.selectedObject.fill}}" onclick="setFullColor();"><span ng-hide="adjust">Ajuster la teinte</span></button>

                      <div class="w3-col m8">
                        <div class="w3-large" style="font-family:Consolas, 'courier new';">

                          <input id="cmyk01" class="w3-input w3-border" value="{{fabric.selectedObject.fill}}" ng-model="fabric.selectedObject.fill" ng-change="fillColor(fabric.selectedObject.fill);" type="text" ng-click="adjust=false" onclick="setFullColor();">
                        ...
                        <div class="swatch-selector" id="color-1">
                          <button class="swatch" style="background-color:#000000;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#000000');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#212121;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#212121');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#333333;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#333333');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#454545;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#454545');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#545454;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#545454');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#787878;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#787878');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#999999;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#999999');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#cccccc;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#cccccc');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#dedede;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#dedede');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#ededed" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#ededed');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#ffffff;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#ffffff');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#4f3c36;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#4f3c36');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#6e5b52;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#6e5b52');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#6e675d;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#6e675d');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#ffff00;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#ffff00');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#ffed00;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#ffed00');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#ff9e1c;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#ff9e1c');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#ff701c;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#ff701c');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#87cc33;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#87cc33');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#008f35;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#008f35');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#137549;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#137549');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#038582;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#038582');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#009ede;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#009ede');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#172882;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#172882');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#17284f;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#17284f');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#011526;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#011526');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#4b0054;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#4b0054');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#421d2e;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#421d2e');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#6b0f1a;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#6b0f1a');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#e3001b;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#e3001b');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#ff0024;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#ff0024');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#ff0066;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#ff0066');" onclick="setFullColor();"></button>
                          <button class="swatch" style="background-color:#ff8ca8;" ng-model="fabric.selectedObject.fill" ng-click="adjust=false;fillColor(fabric.selectedObject.fill = '#ff8ca8');" onclick="setFullColor();"></button>
                        </div>
                      </div>
                    </div> <!--w3-row1-->

                  <div ng-show="adjust" class="adjust">
            ...
            <div class="row">
                <div class="canvas_options">
                    <ul class="clearfix">
                        ...
                        <li ng-click="quicksaveJSON()" title="Enregistrer vos modifications" class="highlight tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-save"></i><span>Sauvegarder</span></li>
                        <li ng-click="retour()" title="Rétablir la dernière sauvegarde" class="highlight tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-undo"></i><span>Rétablir</span></li>
                        <li ng-click="reinitialize()" id="reset" title="Rétablir le gabarit vierge" class="highlight tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-eraser"></i><span>Réinitialiser</span></li>
                        <li ng-click="copyItem()" title="Copier le calque sélectionné" class="tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-copy"></i><span>Copier</span></li>
                        <li ng-click="pasteItem()" title="Coller le calque sélectionné" class="tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-paste"></i><span>Coller</span></li>
                        <li ng-click="selectA()" title="Permet de déplacer ensemble tous vos calques en gardant l'agencement. Cliquez ensuite à l'extérieur de la sélection pour la relâcher" class="tooltip-wide" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-object-group"></i><span class="nope">Tout sélectionner</span></li>
                        <!--<li ng-click="globalAlign();" title="Centrer le calque" class="tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-bullseye"></i><span>Centrer</span></li>-->
                        <li ng-click="horizontalAlign()" title="Centrer horizontalement" class="tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-arrows-h"></i><span>Centrer</span></li>
                        <li ng-click="verticalAlign()" title="Centrer verticalement" class="tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-arrows-v"></i><span>Centrer</span></li>
                        <li ng-click="{ active: flipObject() }" title="Symétrie horizontale" class="tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-exchange"></i><span>Mirroir</span></li>
                        <li ng-click="{ active: flipObjectY() }" title="Symétrie verticale" class="tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-exchange fa-rotate-90"></i><span>Retourner</span></li>
                        <li ng-click="removeSelectedObject()" title="Supprimer le calque sélectionné" class="tooltip-small" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-trash"></i><span>Supprimer</span></li>
                        <!--<li ng-click="undo()" id="undo">
                            <i class="fa fa-undo"></i>
                            <span class="nope">Annuler</span>
                        </li>
                        <li ng-click="redo()" id="redo">
                    ...
                    <div class="btnTopright">
                            ...
                            <ul>
                              <!--<li>
                                ...
                                <!--<li class="retourCom tooltip-wide" data-toggle="tooltip" data-placement="bottom" title="Revenir au détail de votre commande, vos modifications seront sauvegardées" ng-click="quicksaveJSON()"  title="retour à votre commande">
                                  <a  href="#" class="ng-scope"><i class="fa fa-shopping-cart"></i><span>Retour</span></a>
                                </li>-->

                                <li class="saveModif tooltip-wide" data-toggle="tooltip" data-placement="bottom" title="Sauvegarder et revenir à votre commande pour reprendre votre maquette plus tard" ng-click="saveObjectAsJSON()">
                                  <a href="#" class="ng-scope"><i class="fa fa-sign-out fa-flip-horizontal"></i><span>Quitter<br /> </span></a>
                                </li>

                                <li class="saveObject tooltip-wide" data-toggle="tooltip" data-placement="bottom" title="Une fois votre maquette terminée, cliquez ici pour la transmettre à notre service infographie">
                                    <a ng-hide="loader" ng-click="saveObjectAsJpg();" href="#" class="ng-scope"><i class="fa fa-send" ></i><br /><span>Envoyer</span></a>
                  ...
                  <ul class="zoomButtons pull-right">
                    ...
                    <div class='fabric-container'>
                        ...
                        <div class="canvas-container-outer">
                            <canvas fabric='fabric' id="discan"></canvas>
                        </div>
    ...
    <footer class="footer">
      ...
      <div class="txta">
        <div class="bienv">Bienvenue sur l'application "Maquette en ligne" de France Banderole ! Vous personnalisez votre <?php echo $nbname; ?> <?php echo $nbh; ?> x <?php echo $nbl; ?> <?php if ($rectoVerso >= 1){
          if ($verso != 1) {
            echo '<span id="rectvers">Recto</span>';
          }else if ($verso == 1){
            echo '<span id="rectvers">Verso</span>';
