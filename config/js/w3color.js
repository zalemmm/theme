...
function drawCyanTable() {
    ...
    for (i = 0; i <= 100; i++) {
        ...
        x += "<td style='background-color:" + color.toRgbString() + ";height:14px;padding:2px 0;' onmousemove='tooltip(0, " + i + ")' onclick='clickCyan(" + i + ")'></td>";
    }
    x += "</tr>";
    x += "</table>";
...
function drawMagentaTable() {
    ...
    for (i = 0; i <= 100; i++) {
        ...
        x += "<td style='background-color:" + color.toRgbString() + ";height:14px;padding:2px 0;' onmousemove='tooltip(1, " + i + ")' onclick='clickMagenta(" + i + ")'></td>";
    }
    x += "</tr>";
    x += "</table>";
...
function drawYellowTable() {
    ...
    for (i = 0; i <= 100; i++) {
        ...
        x += "<td style='background-color:" + color.toRgbString() + ";height:14px;padding:2px 0;' onmousemove='tooltip(2, " + i + ")' onclick='clickYellow(" + i + ")'></td>";
    }
    x += "</tr>";
    x += "</table>";
...
function drawBlackTable() {
    ...
    for (i = 0; i <= 100; i++) {
        ...
        x += "<td style='background-color:" + color.toRgbString() + ";height:14px;padding:2px 0;' onmousemove='tooltip(3, " + i + ")' onclick='clickBlack(" + i + ")'></td>";
    }
    x += "</tr>";
    x += "</table>";
