...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	...
	<head profile="http://gmpg.org/xfn/11">
		...
		if(is_page('configurateur')) {
			echo '<meta name="msapplication-TileColor">
	    <meta name="theme-color">
	    <link rel="stylesheet" type="text/css" href="'.get_bloginfo("template_url").'/config/css/font-awesome.min.css" >
	    <link rel="stylesheet" type="text/css" href="'.get_bloginfo("template_url").'/config/css/normalize.css" >
	    <link rel="stylesheet" type="text/css" href="'.get_bloginfo("template_url").'/config/css/bootstrap.min.css" >
	    <link rel="stylesheet" type="text/css" href="'.get_bloginfo("template_url").'/config/css/ng-scrollbar.min.css" >
	    <link rel="stylesheet" type="text/css" href="'.get_bloginfo("template_url").'/config/css/style.css" >
	    <link rel="stylesheet" type="text/css" href="'.get_bloginfo("template_url").'/config/css/custom.css" >
	    <link rel="stylesheet" type="text/css" href="'.get_bloginfo("template_url").'/config/css/bootstrap-colorpicker.min.css">
	    <link rel="stylesheet" type="text/css" href="'.get_bloginfo("template_url").'/config/css/angular-material.css">
	    <script type="text/javascript" src="'.get_bloginfo("template_url").'/config/js/bootstrap.min.js"></script>';
		}else{
			echo '';
		}
		?>
