...
<div class="container ng-scope" ng-controller="ProductCtrl" ng-app="productApp" id="productApp">
    <div ng-show="loading" class="loading">
        <h1 class="lodingMessage">Initializing Design Tool<img src="<?php echo bloginfo("template_url") ?>/config/images/ajax-loader.gif"></h1>
    </div>
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 canvas_section pull-right">
            <div class="row">
                <div class="canvas_options">
                    <ul class="clearfix">
                        <li ng-click="layers()" href="#Layers" data-toggle="tab"><i class="fa fa-object-ungroup"></i><span>Layers</span></li>
                        ...
                        <li ng-click="forwardSwap()"><i class="fa fa-mail-forward"></i><span>Forward <br> Swap</span></li>
                        <li ng-click="backwordSwap()"><i class="fa fa-mail-reply"></i><span>Backward <br> Swap</span></li>
                        <li ng-click="horizontalAlign()"><i class="fa fa-arrows-h"></i><span>Horizontal <br> Align</span></li>
                        <li ng-click="verticalAlign()"><i class="fa fa-arrows-v"></i><span>Vertical Align</span></li>
                        <li ng-click="{ active: flipObject() }"><i class="fa fa-exchange fa-2"></i><span>Flip</span></li>
                        <li ng-click="lockObject()"><i ng-class="isLocked() ? 'fa-lock' : 'fa-unlock'" class="fa fa-2"></i><span>Lock Layer</span></li>
                        <li ng-click="removeSelectedObject()"><i class="fa fa-eraser"></i><span>Remove <br>Layer </span></li>
...
<section class="customizer" id="customizer">
    <a href="http://designtailor.veepixel.com/"><img src="<?php echo bloginfo("template_url") ?>/config/images/logo.png" alt="" class="logo"></a>
    <div class="selector">
          ...
          <div class="color_section color_block">
              ...
              <div class="col-lg-12 color-mixer">
                ...
                <ul id="canvas_color_selector" class="color_selector canvas_selector">
                      <li data-attr="<?php echo bloginfo("template_url") ?>/images/site_bg_01.jpg" class="canvas_1"></li>
                      <li data-attr="<?php echo bloginfo("template_url") ?>/images/site_bg_02.jpg" class="canvas_2"></li>
                      <li data-attr="<?php echo bloginfo("template_url") ?>/images/site_bg_03.jpg" class="canvas_3"></li>
                      <li data-attr="<?php echo bloginfo("template_url") ?>/images/site_bg_04.jpg" class="canvas_4"></li>
                </ul>
                <span class="customizer_headings">Page Layout</span>
                <ul class="layout_options">
                      <li><a href="index.html"><img src="<?php echo bloginfo("template_url") ?>/config/images/layout_2.jpg" style="width: 60px;"></a></li>
                      <li><a href="index_01.html"><img src="<?php echo bloginfo("template_url") ?>/config/images/layout_1.jpg" style="width: 60px;"></a></li>
                      <li><a href="index_02.html"><img src="<?php echo bloginfo("template_url") ?>/config/images/layout_3.jpg" style="width: 60px;"></a></li>
                </ul>
          </div>
    </div>
...
<script src="<?php echo bloginfo("template_url") ?>/config/assets/angular.js"></script>

<script src="<?php echo bloginfo("template_url") ?>/config/assets/angular-animate.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/angular-aria.js"></script>

<script src="<?php echo bloginfo("template_url") ?>/config/assets/angular-material.js"></script>

<script src="<?php echo bloginfo("template_url") ?>/config/assets/ng-file-upload/angular-file-upload.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/ng-file-upload/angular-file-upload-shim.js"></script>

<script type="text/javascript" src="<?php echo bloginfo("template_url") ?>/config/assets/qr-code/raphael-2.1.0-min.js"></script>
<script type="text/javascript" src="<?php echo bloginfo("template_url") ?>/config/assets/qr-code/qrcodesvg.js"></script>

<script src='assets/word-cloud/d3.v3.min.js'></script>
<script src='assets/word-cloud/d3.layout.cloud.js'></script>

<script src="<?php echo bloginfo("template_url") ?>/config/assets/angular-sanitize.min.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/ng-scrollbar.min.js"></script>

<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabric.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabric.min.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabricCanvas.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabricConstants.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabricDirective.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabricDirtyStatus.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabricUtilities.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabricWindow.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabric.curvedText.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/fabric/fabric.customiseControls.js"></script>

<script src="<?php echo bloginfo("template_url") ?>/config/assets/colorpicker/bootstrap-colorpicker-module.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/js/application.js"></script>

<script src="<?php echo bloginfo("template_url") ?>/config/assets/file/fileSaver.js"></script>
<script src="<?php echo bloginfo("template_url") ?>/config/assets/pdf/jspdf.debug.js"></script>
