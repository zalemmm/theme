  ...
  <div id="content_bg_top">
    <div id="content_zawartosc">
      ...
      <ul id="tarifs">
        ...
        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(1)" @mouseout="turnOut(1)">
          <a itemprop="url" title="banderole - banderole publicitaire - impression banderoles - impression bache - bâche publicitaire - bâches grand format - baches imprimées - bâches personnalisées - impression bâche grand format" href="banderoles/" /><img itemprop="image" class="home-buttons" alt="banderole bache imprimée" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-banderole.png" :class="{ inactive: isInactive, active: active1 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="banderole - banderole publicitaire - impression banderoles - impression bache - bâche publicitaire - bâches grand format - baches imprimées - bâches personnalisées - impression bâche grand format" href="banderoles/">banderole <span class="micro-s">&amp; bâches publicitaires</span></a>
          </div>
          <transition name="slideRight">
            <div class="more" v-show="menu1">
                <a href="banderoles/"><img src="<?php bloginfo('url'); ?>/wp-content/themes/fb/images/btm/bt-banderole.png" />Banderoles</a>
                <a href="banderoles/"><img src="<?php bloginfo('url'); ?>/wp-content/plugins/fbshop/images/fixation/tourillon.svg" />Fixations</span></a>
                <a href="banderoles/"><img src="<?php bloginfo('url'); ?>/wp-content/plugins/fbshop/images/cadre-tissu/cadre.png" />Cadres</span></a>
            </div>
          </transition>
        </li>

        <transition name="slideRight"><li v-show="menu1" style="border:none"></li></transition>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(2)" @mouseout="turnOut(2)">
          <a itemprop="url" title="roll-up - enrouleur - kakemonos - rollup - enrouleurs - impression kakemono tendu - kakemono grand format" href="roll-up/"><img itemprop="image" class="home-buttons" alt="kakemonos &amp; roll-up" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-roll-up.png" :class="{ inactive: isInactive, active: active2 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="kakemono - roll-up - enrouleur - kakemonos - rollup - enrouleurs - impression kakemono tendu - kakemono grand format" href="roll-up/">kakemono roll-up <span class="micro-s">enrouleur</span></a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(3)" @mouseout="turnOut(3)">
          <a itemprop="url" title="kakemono - Totem - kakemonos - blizzard- x-screen - impression kakemono tendu - kakemono grand format" href="totem/"><img itemprop="image" class="home-buttons"  alt="kakemonos &amp; Totem" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-totem.png" :class="{ inactive: isInactive, active: active3 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="kakemono - totem - blizzard - kakemonos - x-screen - clip'it - impression kakemono tendu - kakemono grand format" href="totem/">Totem publicitaire  PLV<span class="micro-s">interieur & exterieur</span></a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(4)" @mouseout="turnOut(4)">
          <a itemprop="url" title="stand-parapluie - stand pliable - stand tissu - bank d'accueil" href="stand-parapluie/"><img itemprop="image" class="home-buttons" alt="stands parapluie stand tissu" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-stand.png" :class="{ inactive: isInactive, active: active4 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="stand-parapluie - stand pliable - stand tissu - bank d'accueil" href="stand-parapluie/">Stand-parapluie <span class="micro-s">Stand tissu & comptoir d'accueil</span></a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(5)" @mouseout="turnOut(5)">
          <a itemprop="url" title="oriflammes - oriflamme - beachflag pas cher - Beach Flag - Windflag - flying banner - voile imprimée - voiles - flag - drapeaux - drapeau voile publicitaire personnalisé" href="oriflammes/"><img itemprop="image" class="home-buttons" alt="oriflammes oriflamme flying banner flag drapeaux" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-oriflamme.png" :class="{ inactive: isInactive, active: active5 }" /></a>
          <div itemprop="name" class="micro" align="center" >
            <a title="oriflammes - oriflamme - flying banner - voile - voiles - flag - drapeaux" href="oriflammes/">Oriflamme <span class="micro-s">BeachFlag Voiles &amp; Drapeaux</span></a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product"  @mouseover="turnIn(6)" @mouseout="turnOut(6)">
          <a itemprop="url" title="impression panneaux forex - panneaux dibond - panneau alu dibond - enseignes alu dibond" href="panneaux-forex-dibond/" >
            <img itemprop="image" class="home-buttons" alt="impression enseignes Dibond - panneaux Forex - panneaux akilux - panneau alvéolaire - panneaux de chantier" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-enseigne.png" :class="{ inactive: isInactive, active: active6 }" />
          </a>
          <div itemprop="name" class="micro" align="center">
            <a title="impression enseignes Dibond - panneaux Forex - panneaux akilux - panneau alvéolaire - panneaux de chantier - impression numérique grand format recto verso" href="panneaux-forex-dibond/">Enseigne publicitaire <span class="micro-s">panneaux Forex - Alu Dibond</span></a>
          </div>
          <transition name="slideRight">
            <div class="more" v-show="menu6">
        ...
        <transition name="slideRight"><li v-show="menu6" style="border:none"></li></transition>

        <li itemscope="" itemtype="http://schema.org/Product"  @mouseover="turnIn(7)" @mouseout="turnOut(7)">
          <a itemprop="url" title="impression panneaux akilux pas cher - panneaux akylux - panneau alvéolaire - panneaux de chantier - panneaux akilux agence immobiliere " href="panneaux-akilux/" >
            <img itemprop="image" class="home-buttons" alt="Panneaux Akilux" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-panneau.png" :class="{ inactive: isInactive, active: active7 }" />
          </a>
          <div itemprop="name" class="micro" align="center">
            <a title="impression panneaux akilux pas cher - panneaux akylux - panneau alvéolaire - panneaux de chantier - panneaux akilux agence immobiliere" href="panneaux-akilux/">Panneau Akilux <span class="micro-s">panneau Immo - chantier</span></a>
          </div>
          <transition name="slideRight">
            <div class="more" v-show="menu7">
              <a href="<?php bloginfo('url'); ?>/panneaux-akilux-3mm/">Akilux 3mm</a>
              <a href="<?php bloginfo('url'); ?>/panneaux-akilux-3_5mm/">Akilux 3.5mm</a>
              <a href="<?php bloginfo('url'); ?>/panneaux-akilux-5mm/">Akilux 5mm</a>
              <a href="<?php bloginfo('url'); ?>/pvc-300-microns/">PVC 300 microns</a>
            </div>
          </transition>
        </li>

        <transition name="slideRight"><li v-show="menu7" style="border:none"></li></transition>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(8)" @mouseout="turnOut(8)">
          <a itemprop="url" title="tente publicitaire d'exposition pliante - barnum personnalisé - chapiteau publicitaire" href="tente-publicitaire-barnum"><img itemprop="image" class="home-buttons"  alt="tentes d'exposition" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-tentes.png" :class="{ inactive: isInactive, active: active8 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="tente d'exposition pliante - barnum" href="tente-pliante-exposition">Tente publicitaire <span class="micro-s">chapiteau & Barnum</span></a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(9)" @mouseout="turnOut(9)">
          <a itemprop="url" title="Habillage pour stand d'exposition - PLV interieur - porte affiche - porte document - accessoires pose - mur d'image - photocall " href="stand-exposition-plv-interieur/"><img itemprop="image" class="home-buttons"  alt="Habillage pour stand d'exposition - PLV interieur - porte affiche - porte document - accessoires pose - mur d'image - cadre aluminium - photocall" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-habillage-stand.png" :class="{ inactive: isInactive, active: active9 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="Habillage pour stand d'exposition" href="stand-exposition-plv-interieur/">Habillage stand<span class="micro-s">et PLV intérieur</span></a>
          </div>
          <transition name="slideRight">
            <div class="more" v-show="menu9">
                <a href="cadre-tissu/">Cadres tissu</a>
                <a href="enseigne-suspendue-textile/">Enseignes suspendues</span></a>
                <a href="plv-interieur/">PLV intérieur</span></a>
            </div>
          </transition>
        </li>

        <transition name="slideRight"><li v-show="menu9" style="border:none"></li></transition>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(10)" @mouseout="turnOut(10)">
          <a itemprop="url" title="Impression de nappes publicitaires pour salon, séminaire, showroom, mariage - forme ronde, carrée ou rectangulaire" href="nappes-publicitaires/"><img itemprop="image" class="home-buttons" alt="Nappe imprimée" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-nappes.png" :class="{ inactive: isInactive, active: active10 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="" href="nappes-publicitaires/">Nappe publictaire<span class="micro-s">personnalisée</span></a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(11)" @mouseout="turnOut(11)">
          <a itemprop="url" title="PLV exterieur - interieur - porte affiche - porte document - accessoires pose - mur d'image - cadre aluminium - photocall - stand autoportant extérieur" href="plv-exterieur/"><img itemprop="image" class="home-buttons"  alt="PLV exterieur - interieur - porte affiche - porte document - accessoires pose - mur d'image - cadre aluminium - photocall - stand autoportant extérieur" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-PLV-ext.png" :class="{ inactive: isInactive, active: active11 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="PLV exterieur - interieur - porte affiche - porte document - accessoires pose - mur d'image - cadre aluminium - photocall - stand autoportant extérieur" href="plv-exterieur/">PLV exterieur</a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product"  @mouseover="turnIn(12)" @mouseout="turnOut(12)">
          <a itemprop="url" title="vinyles adhésifs - Stickers - Autocollants - magnets - Covering - habillage voiture camion - Vitrophanie - film micro perforée imprimé et magnétiques repositionnable" href="stickers/" >
            <img itemprop="image" class="home-buttons"  alt="vinyles adhésifs - Stickers - Autocollants - magnets - Covering - habillage voiture camion - Vitrophanie - film micro perforée imprimé et magnétiques repositionnable" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-stickers.png" :class="{ inactive: isInactive, active: active12 }" />
          </a>
          <div itemprop="name" class="micro" align="center">
            <a title="vinyles adhésifs - Stickers - Autocollants - magnets - Covering - habillage voiture camion - Vitrophanie - film micro perforée imprimé et magnétiques repositionnable" href="stickers/">Autocollant <span class="micro-s">&amp; Stickers Lettrage adhésif</span></a>
          </div>

          <transition name="slideRight">
            <div class="more" v-show="menu12">
              <a href="<?php bloginfo('url'); ?>/autocollant/"><img src="<?php bloginfo('url'); ?>/wp-content/themes/fb/images/btm/bt-autocollant.png" alt="stickers, autocollants, vitrophanie">autocollant</a>
              <a href="<?php bloginfo('url'); ?>/sticker-predecoupe/"><img src="<?php bloginfo('url'); ?>/wp-content/themes/fb/images/btm/bt-stickers-predecoupe.png" alt="stickers, autocollants, vitrophanie">sticker prédécoupé</a>
              <a href="<?php bloginfo('url'); ?>/sticker-lettrage-predecoupe/"><img src="<?php bloginfo('url'); ?>/wp-content/themes/fb/images/btm/bt-stickers-lettrage-predec.png" alt="stickers, autocollants, vitrophanie">sticker lettrage</a>
              <a href="<?php bloginfo('url'); ?>/vitrophanie/"><img src="<?php bloginfo('url'); ?>/wp-content/themes/fb/images/btm/bt-vitrophanie.png" alt="stickers, autocollants, vitrophanie">vitrophanie</a>
              <a href="<?php bloginfo('url'); ?>/sticker-mural/"><img src="<?php bloginfo('url'); ?>/wp-content/themes/fb/images/btm/bt-stickers-mur.png" alt="stickers, autocollants, vitrophanie">sticker mural</a>
            </div>
          </transition>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(13)" @mouseout="turnOut(13)">
          <a itemprop="url" title="Affiche - affiches grand petit format - affiche à l'unité - poster xxl - Posters" href="affiches"><img itemprop="image" class="home-buttons"  alt="impression affiche et poster grand format" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-affiche.png" :class="{ inactive: isInactive, active: active13 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="Affiche - affiches grand petit format - affiche à l'unité - poster xxl - Posters - poster grand format" href="affiches">Affiche <span class="micro-s">&amp; Posters XXL</span></a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(14)" @mouseout="turnOut(14)">
          <a itemprop="url" title="impression carte de visite - Cartes de visites - cartes postales - carte postale personnalisée" href="cartes"><img itemprop="image" class="home-buttons"  alt="impression carte de visite carte postale personnalisée" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-carte.png" :class="{ inactive: isInactive, active: active14 }" /></a>
          <div itemprop="name" class="micro" align="center">
            <a title="impression carte de visite - Cartes de visites - cartes postales - carte postale personnalisée" href="cartes">Carte de visite <span class="micro-s">&amp; postales</span></a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(15)" @mouseout="turnOut(15)">
          <a itemprop="url" title="Flyer - flyers pas cher - flyer rapide - Prospectus" href="flyers"><img itemprop="image" class="home-buttons" lt="flyer prospectus" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-flyer.png" :class="{ inactive: isInactive, active: active15 }" /></a>
          <div itemprop="name" class="micro" align="center"><a title="Flyer - flyers pas cher - flyer rapide - Prospectus" href="flyers">Flyer / Dépliant<span class="micro-s">&amp; Prospectus</span></a>
          </div>
        </li>

        <li itemscope="" itemtype="http://schema.org/Product" @mouseover="turnIn(16)" @mouseout="turnOut(16)">
          <a itemprop="url" title="promotions banderoles pas cher - baches imprimées - bâches évènementielles - bâche publicitaire discount" href="promotions/"><img itemprop="image" class="home-buttons"  alt="promotion banderoles pas cher - baches imprimées - bâches évènementielles - bâche publicitaire discount" src="//www.france-banderole.com/wp-content/themes/fb/images/bt/bt-promo.png" :class="{ inactive: isInactive, active: active16 }" /></a>
          <div itemprop="name" class="micro" align="center"><a title="promotions banderoles pas cher - baches imprimées - bâches évènementielles - bâche publicitaire discount" href="promotions/">Promotions</a>
          </div>
        </li>
      </ul>
      ...
      <div class="storycontent">
        ...
        <hr style="margin-bottom: 10px;" /><small>
          ...
          <div class="important mc_texte">
            <p class="depuis"><span class="ribbon">Depuis maintenant<br />10 ans</span><br />
              <strong itemprop="brand">France Banderole</strong> vous offre la meilleur impression et le meilleur rapport qualité/prix/réactivité pour la bâche imprimée et vous permettre d'acheter des banderoles pour tous les usages.
            </p>
            ...
            <div class="toggle-block" style="display:none;">
              Que votre banderole soit prévue pour être accrochée en intérieur ou en extérieur, vous avez le choix du matériau (bâche PVC, banderole écologique, bache non-tissée) adaptée en fonction de vos besoins. Les <span itemprop="name">banderoles</span> publicitaires sont devenues un élément incontournable de la communication institutionnelle pour tous les communicants. En effet que vous soyez une Mairie, un centre culturel, une association, une communauté de communes, un établissement public, une agence de publicité, un marchand de bien, une agence immobilière, une concession automobile, une enseigne de la grande distribution ou bien même un de nos confrères imprimeurs ou toute autre professionnel de l'impression, vous avez besoin de communiquer à moindre frais. Acheter des <span itemprop="name">banderoles</span> personnalisées étaient jusque là fastidieux. Depuis la création de <strong itemprop="brand">France Banderole</strong>, tous nos tarifs sont en ligne et vous pouvez calculer votre devis rapidement, vous même. Plus besoin d'attendre un hypothétique mail pour avoir un prix chez un imprimeur numérique grand format local. Chez <strong itemprop="brand">France Banderole</strong>, c'est tout de suite ! et depuis binetôt 10 ans avec plus de 26000 clients et plus de 12000 colis expédiés dans tout l'exagone tous les ans, nous avons toujours été les plus rapide à vous livrer et n'avons à déplorer aucun retard dans les livraisons. Aujourd'hui, tous nos confrères nous copient, affichant leurs tarifs de <span itemprop="name">banderoles</span> et de bache publicitaires à grand coup de promotion, de gratuit et de prix au m² toujours plus bas. Soyez rassurés, chez nous, Tous nos produits sont exclusivement Français ou européen, nos encres éco-solvant, Latex ou UV sur nos traceurs grand format de dernière génération sont sans aucune conséquence sur l'environnement, et toutes nos impressions numériques grand format de banderole, bâche publicitaire, kakemono, Sticker, flyers, cartes de visites, dépliants, affiches sont réalisées en France, dans notre atelier de Vitrolles, situé entre Aix en Provence et Marseille. Nous sommes Français, Nous imprimons en France et nous en sommes fiers !<br />
              ...
              <img class="toggle-button goTop" title="remonter en haut de page" alt="remonter en haut de page" src="//www.france-banderole.com/wp-content/themes/fb/img/top.png" :class="{ inactive: isInactive, active: active }" />
            </div>
          </div>
      </div>
