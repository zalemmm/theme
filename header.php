						...
						<a href="<?php bloginfo('url'); ?>/index.php"><img class="logoSmall" src="https://www.france-banderole.com/wp-content/themes/fb/images/logoSmall.png" alt="logo france banderole" /></a>
							<li onmouseover="tipShow('produit_sub');" onmouseout="tipHide('produit_sub');"><a href="<?php bloginfo('url'); ?>/index.php"<?php if(is_page('Accueil')) echo ' id="active"'; ?>>Tarifs en ligne</a>
								...
								<ul id="produit_sub" class="menu_hover">
									...
									<li><a href="<?php bloginfo('url'); ?>/flyers/" class="menu_sub"<?php if(is_page('flyers')) echo ' id=active_sub'; ?>><img src="<?php bloginfo('url'); ?>/wp-content/themes/fb/images/btm/bt-flyer.png" alt="flyers">flyer</a></li>
									...
									<li><a href="<?php bloginfo('url'); ?>/depliants/" class="menu_sub"<?php if(is_page('depliants')) echo ' id=active_sub'; ?>><img src="<?php bloginfo('url'); ?>/wp-content/themes/fb/images/btm/bt-depliant.png" alt="dépliants">dépliant</a></li>
								</ul>
							</li>
